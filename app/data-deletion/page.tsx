      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6">
              ...
              <li>Include:
                <ul className="list-disc pl-6 mt-2">
                  ...
                  <li>Your user ID (if available)</li>
                </ul>
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-6">
              <li>In-app account deletion is applied immediately in the app flow.</li>
              <li>Email deletion requests are typically processed within 7-14 days after we verify the request.</li>
              <li>We delete or anonymize personal data associated with your account, subject to limited legal and safety retention requirements.</li>
